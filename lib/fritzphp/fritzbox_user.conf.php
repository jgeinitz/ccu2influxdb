...
$this->config->setItem('fritzbox_ip', '192.168.31.1');
...
$this->config->setItem('username', 'monitor');
#$this->config->setItem('username', 'admin');

# set to your Fritz!Box password (defaults to no password, will be ignored, when remote config is enabled)
#$this->config->setItem('password', 'Declaration');
$this->config->setItem('password', 'monitor111');
